...
img1 = cv2.resize(image1, dsize=(750, 550), interpolation=cv2.INTER_CUBIC)
img2 = cv2.resize(image2, dsize=(750, 550), interpolation=cv2.INTER_CUBIC)
...
integral = cv2.threshold(img1, sum, -5)
...
while True:
    if keyboard.is_pressed("Y") or keyboard.is_pressed("y"):
        ...
        cv2.imshow("image2",img2), cv2.moveWindow("image2", 770 , 0)
        cv2.imshow("Suma",suma), cv2.moveWindow("Suma", 400, 250)
        cv2.imshow("Resta", resta), cv2.moveWindow("Resta", 400, 280)
        cv2.imshow("Division", division), cv2.moveWindow("Division", 400, 310)
        cv2.imshow("Multiplicacion", multi), cv2.moveWindow("Multiplicacion", 400, 340)
        ##cv2.imshow("Raiz", raiz), cv2.moveWindow("Raiz", 400, 430)
        cv2.imshow("Potencia 2", potencia), cv2.moveWindow("Potencia 2", 400, 370)
        cv2.imshow("Potencia 4", potencia2), cv2.moveWindow("Potencia 4", 400, 400)
